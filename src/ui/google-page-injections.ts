import type { DarkFilterSettings } from "../plugin-settings";

export const SHARE_DROPDOWN_SHIM = `
	(() => {
...
export const SHARE_DROPDOWN_CSS = `
...
export function buildDarkContentCss(filter: DarkFilterSettings): string {
  const rootFilter = [
